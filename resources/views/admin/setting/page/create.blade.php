                  ...
                  <form action="{{ route('page.store') }}" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="test" class="form-control" id="page_title" name="page_title" placeholder="Page title">

                      </div>

                      <div class="form-group">
                        <label for="page_description" class="form-label">Page Description</label>
                        <textarea name="page_description"  class="form-control summernote" rows="4">{{ old('page_description') }}</textarea>
                    </div>
