                ...
                <div class="col-lg-5 offset-lg-4 fill_height">
                    <div class="banner_content">
                        ...
                        <div class="banner_price">
                           ...
                           @else
                            <span> {{ $setting->currency }} {{ $banner_product->selling_price }}</span> {{ $setting->currency }} {{ $banner_product->discount_price }}
                            @endif
                        </div>
                        <div class="banner_product_name">{{ $banner_product->brand->brand_name }}</div>
                        <div class="button banner_button"><a href="{{ route('product.details',$banner_product->product_slug) }}">Shop Now</a></div>
                    </div>
                </div>
        </div>
